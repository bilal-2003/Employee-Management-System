...
root.geometry("1920x900+0+0")
root.config(bg="#012124")
root.state("zoomed")
...
# Entries Frame
entries_frame = Frame(root, bg="#012124")
entries_frame.pack(side=TOP, fill=X)
title = Label(entries_frame, text="Employee Management System", font=("Calibri", 18, "bold"), bg="#012124", fg="white")
title.grid(row=0, columnspan=2, padx=10, pady=20, sticky="w")

lblName = Label(entries_frame, text="Name", font=("Calibri", 16), bg="#012124", fg="white")
lblName.grid(row=1, column=0, padx=10, pady=10, sticky="w")
txtName = Entry(entries_frame, textvariable=name, font=("Calibri", 16), width=30)
txtName.grid(row=1, column=1, padx=10, pady=10, sticky="w")

lblAge = Label(entries_frame, text="Age", font=("Calibri", 16), bg="#012124", fg="white")
...
lblGender = Label(entries_frame, text="Gender", font=("Calibri", 16), bg="#012124", fg="white")
...
lblContact = Label(entries_frame, text="Contact No", font=("Calibri", 16), bg="#012124", fg="white")
...
lblAddress = Label(entries_frame, text="Address", font=("Calibri", 16), bg="#012124", fg="white")
...
btn_frame = Frame(entries_frame, bg="#012124")
